...
rm -rf "$generated_dir"
mkdir -p "$corpus_root/farbfeld_decode" "$corpus_root/qoi_decode" "$corpus_root/pnm_decode" "$corpus_root/png_decode" "$corpus_root/bmp_decode" "$corpus_root/jpeg_decode" "$corpus_root/webp_decode" "$corpus_root/gif_decode" "$corpus_root/tiff_decode"
...
cp "$generated_dir/gradient-64.tiff" "$corpus_root/tiff_decode/gradient-64.tiff"
...
printf 'II' >"$corpus_root/tiff_decode/le-magic-truncated.tiff"
printf 'MM' >"$corpus_root/tiff_decode/be-magic-truncated.tiff"
printf 'II\x2a\x00' >"$corpus_root/tiff_decode/le-magic-only.tiff"
printf 'MM\x00\x2a' >"$corpus_root/tiff_decode/be-magic-only.tiff"
printf 'II\x2a\x00\x08\x00\x00\x00' >"$corpus_root/tiff_decode/le-header-no-ifd.tiff"
printf 'MM\x00\x2a\x00\x00\x00\x08' >"$corpus_root/tiff_decode/be-header-no-ifd.tiff"
printf 'II\x2a\x00\x08\x00\x00\x00\x00\x00\x00\x00\x00\x00' >"$corpus_root/tiff_decode/le-empty-ifd.tiff"
printf 'XX\x2a\x00\x08\x00\x00\x00' >"$corpus_root/tiff_decode/bad-byte-order.tiff"
printf 'II\xff\xff\x08\x00\x00\x00' >"$corpus_root/tiff_decode/bad-magic-number.tiff"
