...
```sh
scripts/generate-homebrew-formula.sh v0.15.0 SHA256SUMS imx.rb
```
...
For v0.15.0, the generated tap formula includes Linux archive blocks present in
...
v0.13 resize, v0.14 resize-fit, and v0.15 batch-convert smoke, before support
is claimed.
