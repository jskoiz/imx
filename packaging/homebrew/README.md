...
```sh
scripts/generate-homebrew-formula.sh v0.13.0 SHA256SUMS imx.rb
```
...
For v0.13.0, the generated tap formula includes Linux archive blocks present in
...
v0.13 resize smoke, before support is claimed.
