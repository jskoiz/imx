...
```sh
scripts/generate-homebrew-formula.sh v0.12.0 SHA256SUMS imx.rb
```
...
For v0.12.0, the generated tap formula includes Linux archive blocks present in
...
including JPEG EXIF Orientation, progressive JPEG, and v0.12 intake smoke,
